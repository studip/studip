...
<div id="mvv-aufbaustg-table">
    ...
    <table class="default sortable-table" data-sortlist="[[0, 1]]">
        ...
        <thead>
            <tr class="sortable">
                <th data-sorter="text"><?= _('Aufbaustudiengang'); ?></th>
                <th data-sorter="text"><?= _('Typ'); ?></th>
                <th data-sorter="false"><?= _('Bemerkung'); ?></th>
                <th data-sorter="false"></th>
            </tr>
        </thead>
        <tbody>
        <? if (count($grund_stg->aufbaustg_assignments)) : ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <? if (trim($aufbau_stg->kommentar)) : ?>
                        <a data-dialog="size=auto" href="<?= $controller->url_for('studiengaenge/studiengaenge/aufbaustg_info', $aufbau_stg->id) ?>">
                ...
                <td class="actions">
                    ...
                    <a data-dialog="size=auto" href="<?= $controller->url_for('studiengaenge/studiengaenge/aufbaustg_edit', $aufbau_stg->id) ?>">
                        <?= Icon::create('edit') ?>
                    </a>
                    <? endif; ?>
