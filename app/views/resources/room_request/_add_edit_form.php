<? if ($show_form): ?>
    <form class="default" method="post" id="room_request-form" action="<?= $form_action_link ?>"
        ...
        <fieldset id="start_date_section">
            ...
            <section>
                ...
                <label id="end_date_section" style="min-width: 40%;<?= ($begin_date_str == $end_date_str) ? 'display: none;' : ''; ?>" class="col-2">
                    <?= _('Enddatum') ?>
            ...
            <section>
                <label class="col-2">
                    <?= _('Startzeit') ?>
                    <input type="text" name="begin_time" class="has-time-picker size-s" value="<?= htmlReady($begin_time_str) ?>">
                </label>
                <label class="col-2">
                    <?= _('Endzeit') ?>
                    <input type="text" name="end_time" class="has-time-picker size-s" value="<?= htmlReady($end_time_str) ?>">
                </label>
            </section>
            <label>
                <?= _('Rüstzeit') ?>
