...
<table id="mvv_files" class="default collapsable">
    ...
    <thead>
        <tr>
            <?= $controller->renderSortLink('materialien/files/', _('Name'), 'name') ?>
            <?= $controller->renderSortLink('materialien/files/', _('Dateiname'), 'filename') ?>
        ...
        <tr class="header-row">
            <td class="toggle-indicator">
                <a class="mvv-load-in-new-row"
                    href="<?= $controller->url_for('materialien/files/details', $mvv_file->mvvfile_id) ?>"><?= htmlReady($mvv_file->getDisplayName()) ?>
                </a>
            </td>
            <td class="dont-hide">
            ...
            <td class="dont-hide"><?= htmlReady(date('d.m.Y', $mvv_file->mkdate)); ?></td>
